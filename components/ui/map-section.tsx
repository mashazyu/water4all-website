...
export function MapSection({ className }: MapSectionProps) {
  ...
  return (
    <section className={`relative w-full min-h-screen flex items-center justify-center bg-gradient-to-br from-muted via-white to-blue-50/20 py-20 md:py-20 lg:py-24 ${className || ''}`}>
